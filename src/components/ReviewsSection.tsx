...
const ReviewsSection = () => {
  ...
  const allReviews = [
    ...
    },
    {
      ...
      content: "I need to mention something personal. It was the faint 'swampy' odor that I was so paranoid about, which Dr. Weil mentioned in his video. I felt truly seen. After about a month on Dominus, it's completely gone. That specific relief, for me, was worth everything."
    },
    {
      id: 8,
      author: "Martha H.",
    ...
    },
    {
      ...
      content: "My grandson's wedding was six months away, and I was secretly dreading it. At Christmas last year, I couldn't even stand long enough for the family photo without agonizing pain. The thought of the wedding, let alone dancing, brought me to tears. I started taking Dominus after a friend sent me Dr. Weil's video. I was hopeful, but realistic. Well, last Saturday, not only did I stand for all the photos with a huge smile on my face, but I danced the night away with my husband and my grandson. My family was stunned, and I felt 20 years younger. I have this formula to thank for a memory I will cherish forever."
    }
  ];
